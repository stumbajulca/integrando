...
\usepackage[utf8]{inputenc} % para espa<f1>ol
\usepackage{longtable}

\usepackage{Sweave}
\begin{document} % Comienza latex
...
% Date and time: mié, jul 25, 2018 - 19:02:42
